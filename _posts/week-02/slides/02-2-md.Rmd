...
- Using the *Explorer* side bar, open you Markdown file from Tuesday.
...
This is very useful but can also get a bit confusing &ndash; which syntax is
supported where?
]
...
.content-box-info[
See [this bonus slide](#md-bonus) for some additional Markdown syntax.
]
...
## Bonus: VS Code keyboard shortcuts
...
## Bonus: VS Code keyboard shortcuts (cont.)
...
## Bonus: Some handy HTML to use in Markdown
