...
- **How to manage simultaneous variants of files**, such as when making
...
## What a Version Control System roughly does
...
.content-box-info[
One database (*repository*) manages the files
...
and (?) the best way to learn what's going on.
...
**Tracked files can be in three states:**
  ...
  - Modified (and not staged) since the last commit (*modified*)
...
<figure>
<p align="center">
<img src="img/git-head-notation.svg" width="85%">
</p>
</figure>
...
- Let's also change an *existing line* in `todo.txt`:
  - Find the file in the VS Code *Explorer* side bar, and click on it.
  - Change "essay" to "essays", save the file, and type:
