...
## Aliases for unwieldy `sstat` and <br> `sacct` commands
...
.content-box-info[
Use the full path `/usr/bin/time` to get all the information shown.
]
...
- As an alternative to writing a loop script, you can also make your original
  (say, `fastqc_single.sh`) script submit a job "array", i.e. a series of jobs: 
