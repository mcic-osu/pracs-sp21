...
- To delete one or more elements, use the *function* `del`:
...
- `sorted` &ndash; Return a sorted list:
...
- `.keys()` and `.values()` create list-like objects from the keys and values:
...
Tuples are similar to lists, in that they contain a seqeunce of values of any
