...
Here is a type of indexing (so-called "fancy indexing") that is possible with a
NumPy array but not a list &ndash; providing multiple values as a list:
...
However, NumPy typically operate on multi-line arrays at once,
and therefore **read files into memory all at once**,
...
<p align="center">
<img src=img/numpy-img_red.png width="55%">
</p>

---
background-color: #f2f5eb

## Exploring the image as a NumPy array
...
- Therefore, we can use the NumPy methods we have learned about.
  ...
  with the four RGBA channels along the 3rd dimension:
    - Red (index 0)
    - Green (index 1)
    - Blue (index 2)
...
## Exploring the image as a NumPy array (cont.)
...
## Setting a masking threshold (cont.)
...
<p align="center">
<img src=img/numpy-img_redline.png width="50%">
</p>
...
.pull-right[
<p align="left">
<img src=img/numpy-img_mask1.png width="100%">
</p>
]
...
<p align="center">
<img src=img/numpy-img_mask2.png width="60%">
</p>
