...
- But, for this to work, we also need to make the script executable:
  ...
  $ chmod u+x script.sh   # Alt: executable for everyone (a=all)
  ```
...
- This type of behavior is useful when you're writing the data to file,
  as you usually will, and you can see a bit of a log printed to screen
  or to a log file.
