...
.content[
In many other instances, you can create the Conda environment in one 
`conda create` step, but ...
]
...
- Now, anyone with access to your environment YAML can easily reproduce your
  environment:
...
$ conda create --name live_env --clone test_env # Clone an environment
conda list -n test_env # List all packages in an environment
```
]
