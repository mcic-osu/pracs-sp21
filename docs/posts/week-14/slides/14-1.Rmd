...
- Some things we didn't cover:
  ...
  - `find` and `xargs`
    ([slides](https://mcic-osu.github.io/pracs-sp21/posts/week-05/slides/05-3_find-xargs.html#1) &ndash; and see Buffalo chapter 7)
  ...
  - Process management and tmux (Buffalo chapter 4)
  - `bioawk` (see Buffalo chapter 7))
  - Parameter expansion
  - tar archives
