...
- Specific tools are not only highly ... specific, they are also easier and perhaps
  better picked up in short "just-in-time workshops" or even using good cookbook-style
...
## Some specific next steps by topic &ndash; Python

- Shell -- we covered quite bit, focus on getting fluent.  
  Some things we didn't cover:
  
  - [Creating links](https://mcic-osu.github.io/pracs-sp21/posts/week-02/slides/02-3-shfiles.html#44)
  - `find` and `xargs` ([slides](https://mcic-osu.github.io/pracs-sp21/posts/week-05/slides/05-3_find-xargs.html#1) &ndash; see Buffalo chapter 7)
  - [`join`](https://mcic-osu.github.io/pracs-sp21/posts/week-04/slides/04-1_data-tools.html#55) to merge tabular data by a shared column
  - Parameter expansion
  - Process management (background jobs)
  - tar archives
  - If you like shell scripts, look into parsing arguments
  - bioawk
...
- Python &ndash; If you want to keep using Python, I would probably recommend
  ...
  See the resources page -- Type of book depends on your preference/direction:
  general Python vs Data Science vs Bioinformatics
...
- Git
  ...
  - Merge conflicts
  - Undoing things ([slides](https://mcic-osu.github.io/pracs-sp21/posts/week-03/slides/03-3_git.html#1))
...
That page now also has further resources for all other topics.
