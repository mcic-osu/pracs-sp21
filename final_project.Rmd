...
Graded aspects for the project focus on clarity, reproducibility and automation
(see below).
...
don't hesitate to contact Jelmer. I don't currently have any ready-to-go project
ideas with accompanying data sets, but I could make one or more, if needed.
