...
**The submission of your final project is due on April 30th.**
<span style="color:coral"><i>[20 points]</i></span>
...
-   **A single (workflow/"driver") script or Snakefile that aims to
...
+---------------------------+------------+---------------------------+
| Category                  | Max. score | High/max. score if your   |
|                           |            | project (examples given): |
+===========================+============+===========================+
| Project organization      | 2          | -   Has a clear and       |
...
|                           |            |     directories.          |
+---------------------------+------------+---------------------------+
| Project background and    | 2          | -   Has a clear           |
| documentation             |            |     description of its    |
...
|                           |            |     directions).          |
+---------------------------+------------+---------------------------+
| Script documentation      | 2          | -   Uses extensive (yet   |
|                           |            |     succinct) comments to |
|                           |            |     document what is      |
|                           |            |     being done within     |
|                           |            |     scripts.              |
+---------------------------+------------+---------------------------+
| Good practices in scripts | 4          | -   Uses no absolute      |
|                           |            |     paths in scripts.     |
|                           |            | -   Uses scripts that     |
|                           |            |     take arguments where  |
...
|                           |            |     overly long and don't |
|                           |            |     do multiple unrelated |
|                           |            |     things.               |
|                           |            | -   Has no scripts with   |
|                           |            |     lines that are        |
|                           |            |     "commented out" (if   |
|                           |            |     you somehow can't get |
|                           |            |     around that, clearly  |
|                           |            |     annotate such lines). |
|                           |            | -   Uses Bash scripts     |
|                           |            |     with proper `set`     |
...
+---------------------------+------------+---------------------------+
| Coding quality and        | 3          | -   Has code that         |
| complexity                |            |     demonstrates an       |
|                           |            |     understanding of      |
...
|                           |            |     Python.               |
|                           |            | -   Uses tools and        |
|                           |            |     commands that are (by |
|                           |            |     and large)            |
|                           |            |     appropriate to        |
|                           |            |     accomplish its goals. |
|                           |            |     (I will not dig in to |
|                           |            |     fine details and      |
|                           |            |     parameter settings.)  |
+---------------------------+------------+---------------------------+
| Workflow reproducibility  | 3          | -   Has a script or       |
|                           |            |     Snakefile that        |
|                           |            |     includes all steps in |
|                           |            |     the workflow and that |
|                           |            |     can actually be run   |
|                           |            |     by anybody who has    |
|                           |            |     access to your        |
|                           |            |     repository and the    |
...
|                           |            |     Conda environments    |
|                           |            |     (preferred) or OSC    |
|                           |            |     modules and no manual |
|                           |            |     installs unless       |
|                           |            |     necessary; YAML       |
|                           |            |     environment files.    |
+---------------------------+------------+---------------------------+
| SLURM jobs at OSC         | 2          | -   Has one or more       |
|                           |            |     scripts that are run  |
|                           |            |     as OSC jobs at SLURM. |
|                           |            | -   Uses appropriate      |
|                           |            |     SLURM directives --   |
...
|                           |            |     these).               |
+---------------------------+------------+---------------------------+
| Version control           | 2          | -   Has Git commit        |
|                           |            |     messages that are     |
|                           |            |     informative.          |
|                           |            | -   Has reasonably        |
|                           |            |     appropriate commits,  |
|                           |            |     e.g. individual Git   |
|                           |            |     commits don't consist |
|                           |            |     of multiple           |
