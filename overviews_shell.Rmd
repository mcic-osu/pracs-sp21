...
| **`\w`**                             | (yes) | **"Word" character**: any alphanumeric character or "\_". Needs `-E` (ERE) in `grep` but not in `sed` (...).                                                   | `grep -E -o 'gene_id "\w+"'` <br> `sed s/\w/X/` (c*hange any word character to X)*                         |
