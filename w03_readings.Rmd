...
Be aware that Git is a rather challenging topic, so this is not a week to slack off.
More specifically:

- If you can, complete the main reading before Tuesday's lecture,
  and also read the Buffalo chapter.
...
As mentioned in the overview page for the week,
Git is a challenging subject, so I recommend you to read both of these chapters
