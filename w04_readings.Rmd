...
the first part of the chapter discusses several tools we've already seen in week 1,
such as `sort`, `cut`, and `uniq.`
The chapter will quickly get more advanced though,
and introduce the trickier but powerful `awk` and `sed` commands.
