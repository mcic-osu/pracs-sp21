...
1. Import the data using *pandas*,
   ...
   With an eye on the next step, where you have to do this for each year,
   it is convenient to write a function that takes the data and a year as input,
   ...
   of a yearis specified as an argument.
...
- To get started, you'll need to install `scikit-image` into your interactive
  Python environment, which you can do as follows:
