...
<details><summary>The script `scripts/cutadapt.sh`</summary><p>
...
<details><summary>The full script `scripts/fastq_filter.R`</summary><p>
...
(You can also find the final workflow files at
`/fs/ess/PAS1855/exercises/week13/bonus/final_workflow`.)
