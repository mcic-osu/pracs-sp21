...
We can conclude that, perhaps surprisingly,
Snakemake does not automatically rerun a workflow when code has changed.
...
- **Run the command above.**  
  *(Again, delete the old output first.)*
...
snakemake -j3 --profile slurm_profile
```
